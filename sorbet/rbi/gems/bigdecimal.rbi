...
module BigDecimal::Internal
  ...
  def self.float_log(x); end
  def self.infinity_computation_result; end
  def self.nan_computation_result; end
  def self.newton_loop(prec, initial_precision: nil, safe_margin: nil); end
  def self.taylor_sum_binary_splitting(x, ds, prec); end
  def self.underflow_computation_result; end
end
module BigMath
  def _exp_binary_splitting(x, prec); end
  def exp(x, prec); end
  def log(x, prec); end
  def self._exp_binary_splitting(x, prec); end
