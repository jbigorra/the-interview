...
class HTTP::ResponseHeaderError < HTTP::ConnectionError
end
class HTTP::SocketReadError < HTTP::ConnectionError
end
class HTTP::SocketWriteError < HTTP::ConnectionError
end
