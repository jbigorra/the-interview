...
class VCR::RequestMatcherRegistry::Matcher < Anonymous_Struct_60
end
class VCR::RequestMatcherRegistry::URIWithoutParamsMatcher < Anonymous_Struct_61
end
...
class VCR::Request < Anonymous_Struct_62
  extend VCR::Normalizers::Body::ClassMethods
  include VCR::Normalizers::Body
  include VCR::Normalizers::Header
end
class VCR::Request::Typed < Anonymous_Delegator_63
end
class VCR::Request::FiberAware < Anonymous_Delegator_64
end
class VCR::Response < Anonymous_Struct_65
  extend VCR::Normalizers::Body::ClassMethods
  include VCR::Normalizers::Body
  include VCR::Normalizers::Header
end
class VCR::ResponseStatus < Anonymous_Struct_66
end
class VCR::HTTPInteraction < Anonymous_Struct_67
end
class VCR::HTTPInteraction::HookAware < Anonymous_Delegator_68
end
module VCR::RSpec
end
